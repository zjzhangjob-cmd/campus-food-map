...
| 用户群体 | 核心特征 | 典型场景 |
|----------|----------|----------|
| 🏢 **上班族** | 25-35岁，商务需求频繁，午餐决策时间短 | 商务聚餐、团队建设、工作日午餐 |
| 🏠 **社区居民** | 全年龄段，追求性价比，关注口碑 | 家庭聚餐、亲子用餐、日常解馋 |
| 🎓 **高校学生** | 18-25岁，价格敏感，社交属性强 | 约会聚餐、社团活动、夜宵 |
| 🚶 **游客/新居民** | 对本地不熟悉，偏好特色体验 | 探索本地美食、网红打卡、节日庆祝 |
...
| 用户痛点 | 解决方案 | 用户价值 |
|----------|----------|----------|
| **「今天吃什么」选择困难** | AI 对话式推荐 + 趣味转盘/PK赛 | 3秒决策，告别选择焦虑 |
| **信息过载，评价失真** | AI 提炼评价标签 + 社区真实种草 | 快速找到真实靠谱的餐厅 |
| **商务宴请不知道去哪** | 场景化智能推荐（高端/氛围/预算） | 体面不踩雷，提升社交效率 |
| **周末想探索周边美食** | 全屏地图模式 + 区域筛选 | 沉浸式发现，探索未知惊喜 |
| **打卡收藏无处管理** | 心愿单 + 积分激励体系 | 养成美食探索习惯，记录生活 |

### 💡 核心价值主张

> **「地图选店 · 社区种草 · AI 帮你做决定」**

- **效率价值**：从「搜索-筛选-决策」全流程平均耗时从 15 分钟缩短到 3 分钟
- **情绪价值**：专属 IP 助手「小觅」提供场景化陪伴，让吃饭不再只是果腹
- **社交价值**：社区圈真实评价 + 种草分享，建立本地美食信任网络
- **探索价值**：地图可视化 + 区域切换，发现身边被忽略的宝藏餐厅
